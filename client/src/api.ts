...
export async function createAppointment(body: AppointmentDto): Promise<AppointmentDetail> {
  const res = await api.post<AppointmentDetail>('/appointments', body)
  return res.data
}

export async function updateAppointment(id: number, body: AppointmentDto): Promise<void> {
